...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Omnifood is a premium food delivery service with the mission to bring affordable meals to as many people as possible">
...
<body>
    ...
    <section class="section-features js--section--features" id="features">
        ...
        <div class="row">
            ...
            <h2 class="features-heading">Get food fast &mdash; not fast food</h2>
            <p class="long-copy">Hello, we’re Omnifood, your new premium food delivery service. We know you’re always busy. No time for cooking. So let
            us take care of that, we’re really good at it, we promise!</p>
        </div>
        ...
        <div class="row js--wp--1">
            <div class="col span-1-of-4 box">
                ...
                <p>Never cook again! We really mean that. Our subscription plans include up to 365 days/year coverage. You can also choose
                to order more flexibly if that's your style.</p>
            </div>
            <div class="col span-1-of-4 box">
                <ion-icon class="icon-big" name="stopwatch"></ion-icon>
                <h3>Ready in 20 minutes</h3>
                <p>You're only twenty minutes away from your delicious and super healthy meals delivered right to your home. We work with
                the best chefs in each town to ensure that you're 100% happy.</p>
            </div>
            <div class="col span-1-of-4 box">
                <ion-icon class="icon-big" name="nutrition"></ion-icon>
                <h3>100% organic</h3>
                <p>All our vegetables are fresh, organic and local. Animals are raised without added hormones or antibiotics. Good for your
                health, the environment, and it also tastes better!</p>
            </div>
            <div class="col span-1-of-4 box">
                <ion-icon class="icon-big" name="cart"></ion-icon>
                <h3>Order anything</h3>
                <p>We don't limit your creativity, which means you can order whatever you feel like. You can also choose from our menu
                containing over 100 delicious meals. It's up to you!</p>
            </div>
        ...
        <ul class="meals-showcase clearfix">
            <li>
                <figure class="meal-photo">
                    <img src="resources/img/1.jpg" alt="Korean bibimbap with egg and vegetables" class="">
                </figure class="meal-photo">
            </li>
            <li>
                <figure class="meal-photo">
    ...
    <section class="cities" id="cities">
        ...
        <div class="row js--wp--3">
            <div class="col span-1-of-4 box">
                <img src="resources/img/lisbon-3.jpg" class="city-img" alt="Lisbon">
                <h3>Lisbon</h3>
            ...
            <div class="col span-1-of-4 box">
                <img src="resources/img/san-francisco.jpg" class="city-img" alt="San Francisco">
                <h3>San Francisco</h3>
                <div class="city-feature">
                    <ion-icon class="icon-small" name="person"></ion-icon>
                    3700+ happy eaters
            ...
            <div class="col span-1-of-4 box">
                <img src="resources/img/berlin.jpg" class="city-img" alt="Berlin">
                <h3>Berlin</h3>
                <div class="city-feature">
                    <ion-icon class="icon-small" name="person"></ion-icon>
                    2300+ happy eaters
            ...
            <div class="col span-1-of-4 box">
                <img src="resources/img/london.jpg" class="city-img" alt="London">
                <h3>London</h3>
                <div class="city-feature">
                    <ion-icon class="icon-small" name="person"></ion-icon>
                    1200+ happy eaters
    ...
    <section class="section-testimonials">
        ...
        <div class="row">
            <div class="col span-1-of-3">
                <blockquote>Omnifood is just awesome! I just launched a startup which leaves me with no time for cooking, so Omnifood is a
            ...
            <div class="col span-1-of-3">
                <blockquote>Inexpensive, healthy and great-tasting meals, delivered right to my home. We have lots of food delivery here in Lisbon,
            ...
            <div class="col span-1-of-3">
                <blockquote>I was looking for a quick and easy food delivery service in San Franciso. I tried a lot of them and ended up with
...
<!-- SECTION PLANS $ -->
    ...
    <section class="js--section--plans" id="plans">
        <div class="row">
        ...
        <div class="row">
            ...
            <div class="col span-1-of-3">
                <div class="plan-box">
                    ...
                    <div>
                        <a href="#" class="btn btn-gohst">Sign up now</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    if($_GET['success'] == 1) {
                     ...
                     if($_GET['success'] == -1) {
                        ...
                        Oops! Somethign went wrong, please try again!
                    </div>";
                    }
...
<!-- FORM SECTION -->
    ...
    <script src="vendors/js/jasmine-jquery.js"></script>
    <script src="vendors/js/jquery-waypoint.js"></script>
